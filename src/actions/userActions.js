...
export const getUserDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${productionUrl}/api/users/${id}`, config)
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${productionUrl}/api/users/profile`,
      user,
      config
    )
...
export const listUsers = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${productionUrl}/api/users`, config)
...
export const deleteUser = (id) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`${productionUrl}/api/users/${id}`, config)
...
export const updateUser = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${productionUrl}/api/users/${user._id}`,
      user,
      config
    )
...
export const sendResetToken = (email) => async (dispatch) => {
  try {
    ...
    await axios.post(
      `${productionUrl}/api/users/forgotpassword`,
      { email },
      config
    )
...
export const checkToken = (verificationCode) => async (dispatch) => {
  try {
    ...
    await axios.post(
      `${productionUrl}/api/users/forgotpassword/check`,
...
export const resetPassword = (verified, newPassword) => async (dispatch) => {
  try {
    ...
    if (verified) {
      ...
      await axios.put(
        `${productionUrl}/api/users/resetpassword`,
        { email, newPassword },
        config
      )
    }
